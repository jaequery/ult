  ...
  return (
    <QueryParamProvider adapter={NextAdapterApp}>
      <div className="dashboard-layout">
        ...
        {/* End Sidebar Toggle */}
        {/* Sidebar */}
        <div className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[10] w-64 border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700 ">
        ...
        {/* End Sidebar */}
        {/* Content */}
        <div className="w-full pt-4 px-4 sm:px-6 md:px-8 lg:ps-72 bg-white">
          {children}
        </div>
        {/* End Content */}
        {/* ========== END MAIN CONTENT ========== */}
