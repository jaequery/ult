    ...
    <>
      ...
      <div className=" rounded-xl  py-4">
        ...
        category?.data?.singlePostOnly ? (
          <>
            <div
              className="text-gray-800 whitespace-pre-line text-left"
            ...
            <div className="">
              ...
              <div className="flex flex-col gap-1">
                {postList?.data?.records?.map((post) => (
                  <div
                    key={post.id}
                    className="grid grid-cols-[1fr,auto] gap-4 items-start bg-white border-gray-200 pb-4"
                  >
                    <Link
                      href={`/posts/${post.id}/${kebabCase(post.title)}?categoryId=${categoryId}`}
                      className="contents"
                    >
                      <div>
                    ...
                    {post?.imageUrl && (
                      <Link
                        href={`/posts/${post.id}/${kebabCase(post.title)}?categoryId=${categoryId}`}
                        className="flex justify-center items-center overflow-hidden rounded-md w-16 h-16"
                      >
